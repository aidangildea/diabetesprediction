...
cols <- names(db_012) %in% c("BMI", "MentHlth", "PhysHlth")
...
log_model_2 <- glm(Diabetes_binary ~ HighBP + HighChol + CholCheck + BMI + Stroke + HeartDiseaseorAttack + PhysActivity + Fruits + HvyAlcoholConsump + GenHlth + MentHlth + PhysHlth + DiffWalk + Sex + Age + Education + Income + Age * HighBP + Age * HeartDiseaseorAttack + Age * HighChol, data = db_binary, family = "binomial")
summary(log_model_2)
```
